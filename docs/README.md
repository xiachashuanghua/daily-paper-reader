...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-19 21:36:58 UTC<br>状态：成功</p>
</section>
...
<p>今日速读 1 篇论文，聚焦多模态肿瘤生存预测，暂无精读内容。</p>
<p>最值得看的方向是《Multi-Modal Tumor Survival Prediction via Graph-Guided Mixture of Experts》（7.0/10）：用图引导的专家混合模型整合多模态数据做生存预测，是值得留意的方法思路。</p>
<p>普通读者可先记住&quot;多模态+图结构+专家混合&quot;这一组合，后续关注它是否在公开临床数据集上得到验证。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Multi-Modal Tumor Survival Prediction via Graph-Guided Mixture of Experts">Multi-Modal Tumor Survival Prediction via Graph-Guided Mixture of Experts</span></li></ul>
  </div>
