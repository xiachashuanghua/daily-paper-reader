...
<p>今天精读1篇8.0分论文，聚焦从源码到预测贡献审计“输入使用声明”的Agent发现细胞模型。</p>
<p>最值得看的是它如何把输入是否被真正使用一路追到预测贡献，以及这种审计思路在Agent自动发现细胞模型中的可信度检验价值。</p>
<p>普通读者可先记住“看模型先看输入有没有真用、贡献能否追溯”，再顺着源码到预测贡献的审计链条判断结论是否可靠。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Discover, Falsify, Revise: Auditing Input-Use Claims from Source Code to Predictive Contribution in Agent-Discovered Cell Models">Discover, Falsify, Revise: Auditing Input-Use Claims from Source Code to Predictive Contribution in Agent-Discovered Cell Models</span></li></ul>
  </div>
