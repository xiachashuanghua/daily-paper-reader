...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-11 20:59:19 UTC<br>状态：成功</p>
</section>
...
<p>今日精读3篇AI生物医学论文：聚焦神经元显微分割与肿瘤多组学对齐，另涉环境健康AI可复现性。</p>
<p>最值得关注9分神作《NeuroRefiner》用形态感知多智能体提升3D荧光显微镜神经元分割，以及8分《DoGMA》以中心法则基座模型统一肿瘤多组学任务。</p>
<p>建议从高分的神经元分割或肿瘤多组学方向切入，先看摘要与图表，再追踪作者开源代码。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="NeuroRefiner: Morphology-Aware Multi-Agent Refinement for 3D Fluorescence Microscopy Neuron Segmentation">NeuroRefiner: Morphology-Aware Multi-Agent Refinement for 3D Fluorescence Microscopy Neuron Segmentation</span></li><li><span class="dpr-home-dashboard-paper-title" title="DoGMA: A Central-Dogma-Guided Foundation Model for Multi-Omics Alignment and Multi-Task Learning in Oncology">DoGMA: A Central-Dogma-Guided Foundation Model for Multi-Omics Alignment and Multi-Task Learning in Oncology</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Agentic Artificial Intelligence for Reproducible Human-in-the-Loop Environmental Health Research">Agentic Artificial Intelligence for Reproducible Human-in-the-Loop Environmental Health Research</span></li></ul>
  </div>
